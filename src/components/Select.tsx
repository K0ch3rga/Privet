   ...
   const toggleselect = (value: string) => {
    ...
    <View>
        ...
        { expanded && <FlatList 
            data={props.data} 
            renderItem={({ item }) => (
                <SelectOption text={item.text} onPress={()=>toggleselect(item.text)} selected={value} />
            )}
        />}
    </View>)
}
...
export const SelectButton = (props: SelectButtonProps) => {
    ...
    <Pressable style={style.Button} onPress={props.onPress}>
        ...
        <Image source={require("../assets/arrow_right.png")} style={style.Arrow}/>
    </Pressable>)
}
...
export const SelectOption = (props: SelectOptionProps) => {
    ...
    <Pressable onPress={props.onPress}>
        ...
        <Text style={[style.OptionText, {textDecorationLine: (props.selected == props.text)?'underline':'none'}]}>{props.text}</Text> 
    </Pressable>)
}
