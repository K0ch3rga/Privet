...
import DropDown from "../components/DropDown"; // Наверное стоит убрать
  ...
  return (
    <View style={styles.wrapper}>
      ...
      <View style={styles.nav}>
        <Text style={styles.header}>{locale[Screens.LanguageChoose].question}</Text>
        <Select data={data.map((d) => d.name)} setChosenValue={changeLocale} />
        <MainButton
          color={mainColor}
          onPress={() => console.log("Pressed")}
          title={locale[Screens.LanguageChoose].continue}
          showArrow={true}
        />
      </View>
    </View>
